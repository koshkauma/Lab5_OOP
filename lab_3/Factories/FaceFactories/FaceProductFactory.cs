...
namespace lab_3.Factories.FaceFactories
{
    public abstract class FaceProductFactory: CosmeticFactory
    {
        ...
        public override List<Control> GetListControl(Size size, int leftCoord)
        {
            ...
            resultList.Add(ComponentCreatorHelper.GetLabel("typeOfFinish", "Финиш", size, new Point(leftCoord, 215), 9));
            ...
            resultList.Add(ComponentCreatorHelper.GetLabel("skinType", "Тип кожи", size, new Point(leftCoord, 260), 11));
